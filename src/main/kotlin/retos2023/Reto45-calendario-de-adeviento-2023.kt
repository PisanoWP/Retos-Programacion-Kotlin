...
class CalendarioADeviento() {
    ...
    fun realizarSorteo() {
        if (participantes.isEmpty()) {
            ...
            val ganador = participantes.random()
            println("El ganador es $ganador ¡¡ENHORABUENA!!")
    ...
    private fun pedirNombreParticipante(pregunta: String): String {
    ...
    private fun pideNumeroPositivo( etiqueta : String): Int {
        var numero: Int? = null
        var valido = false
